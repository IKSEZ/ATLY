...
function HumanBody3D() {
  ...
  const alertas = [
    {
      id: 1,
      area: 'Quadríceps Direito',
      descricao: 'Risco alto de sobrecarga',
      nivel: 'ALTO',
      tipo: 'alto'
    },
    {
      id: 2,
      area: 'Ombro Esquerdo',
      descricao: 'Risco médio de sobrecarga',
      nivel: 'MÉDIO',
      tipo: 'medio'
    },
    {
      id: 3,
      area: 'Panturrilhas',
      descricao: 'Risco baixo de sobrecarga',
      nivel: 'BAIXO',
      tipo: 'baixo'
    }
  ]
  ...
  const regioes = [
    { nome: 'Quadríceps Direito', nivel: 'ALTO', tipo: 'alto' },
    { nome: 'Ombro Esquerdo', nivel: 'MÉDIO', tipo: 'medio' },
    { nome: 'Isquiotibiais', nivel: 'ATENÇÃO', tipo: 'atencao' },
    { nome: 'Panturrilhas', nivel: 'BAIXO', tipo: 'baixo' }
  ]
      ...
      <div className="body3d-main">
        ...
        <div className="body3d-metrics">
          <div className="metric-card">
            ...
            <h2 className="danger-text">1.48</h2>
